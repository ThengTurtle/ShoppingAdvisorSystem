<%@ Page Title="Products" Language="vb" AutoEventWireup="false" MasterPageFile="~/Employee.Master" CodeBehind="EditProduct.aspx.vb" Inherits="SAS1.EditProduct" %>
                                    ...
                                    <table id="discount" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="6"></td>
                                                <td class="text-left">
                                                    <button type="button" onclick="addDiscount();" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add Discount"><i class="glyphicon glyphicon-plus-sign"></i></button>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                    ...
                                    <table id="special" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="5"></td>
                                                <td class="text-left">
                                                    <button type="button" onclick="addSpecial();" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add Special"><i class="glyphicon glyphicon-plus-sign"></i></button>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
                            ...
                            <div class="tab-pane fade" id="tab-reward">
                                <div class="form-group">
                                    ...
                                    <label class="col-lg-2 control-label" for="input-points">
                                        <span data-toggle="tooltip" title="" data-original-title="Number of points needed to buy this item. If you don't want this product to be purchased with points leave as 0.">Points <span class="label label-primary">?</span></span>
                                    </label>
                                    <div class="col-lg-8">
