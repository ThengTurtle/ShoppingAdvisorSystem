<%@ Page Title="Orders" Language="vb" AutoEventWireup="false" MasterPageFile="~/Employee.Master" CodeBehind="EditOrder.aspx.vb" Inherits="SAS1.EditOrder" %>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab-payment">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 text-right">
                                        <button type="button" id="button-payment-address" data-loading-text="Loading..." class="btn btn-primary">Continue</button>
                                    </div>
                                </div>
                            </div>
