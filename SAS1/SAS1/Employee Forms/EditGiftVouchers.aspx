<%@ Page Title="Gift Voucher" Language="vb" AutoEventWireup="false" MasterPageFile="~/Employee.Master" CodeBehind="EditGiftVouchers.aspx.vb" Inherits="SAS1.EditGiftVouchers" %>
    ...
    <div class="col-sm-9 col-sm-offset-4 col-md-10 col-md-offset-2 main">
        <div class="container-fluid">
            ...
            <div class="nav navbar-nav navbar-right">
                <button type="button" id="button-send" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Send"><i class="glyphicon glyphicon-envelope"></i></button>
        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="glyphicon glyphicon-pencil"></i> Edit Gift Voucher</h3>
                </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab-general">
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="code" value="88e7bf5801" placeholder="Code" id="input-code" class="form-control"><br />
                                    </div>
                                </div>
                                <div class="form-group required">
                                    <label class="col-sm-2 control-label" for="input-from-name">From Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="from_name" value="porky" placeholder="From Name" id="input-from-name" class="form-control"><br />
                                    </div>
                                </div>
                                <div class="form-group required">
                                    <label class="col-sm-2 control-label" for="input-from-email">From E-Mail</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="from_email" value="ad@gmail.com" placeholder="From E-Mail" id="input-from-email" class="form-control"><br />
                                    </div>
                                </div>
                                <div class="form-group required">
                                    <label class="col-sm-2 control-label" for="input-to-name">To Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="to_name" value="porky" placeholder="To Name" id="input-to-name" class="form-control"><br />
                                    </div>
                                </div>
                                <div class="form-group required">
                                    <label class="col-sm-2 control-label" for="input-to-email">To E-Mail</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="to_email" value="ad@gmail.com" placeholder="To E-Mail" id="input-to-email" class="form-control"><br />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="voucher_theme_id" id="input-theme" class="form-control">
                                            <option value="7" selected="selected">Birthday</option>
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="message" rows="5" placeholder="Message" id="input-message" class="form-control">da</textarea><br />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-amount">Amount</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="amount" value="1.0000" placeholder="Amount" id="input-amount" class="form-control"><br />
                                    </div>
                                </div>
                                <div class="form-group">
