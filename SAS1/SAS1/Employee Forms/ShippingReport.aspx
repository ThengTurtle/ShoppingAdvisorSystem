<%@ Page Title="Shipping Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/Employee.Master" CodeBehind="ShippingReport.aspx.vb" Inherits="SAS1.ShippingReport" %>
        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="glyphicon glyphicon-stats"></i> Shipping List</h3>
                </div>
                ...
                <div class="panel-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-left">Flat Shipping Rate</td>
                                    <td class="text-right">159</td>
                                    <td class="text-right">$795.00</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">Showing 1 to 20 of 46 (3 Pages)</div>
                    </div>
                </div>
            </div>
