...
Namespace DatabaseComponent
    Public Class EmployeeDB
        ...
        Public Function GetEmployees(ByVal sortExpression As String) As List(Of EmployeeDetails)
            Dim con As New SqlConnection(connectionString)
            Dim cmd As New SqlCommand("GetAllEmployees", con)
            cmd.CommandType = CommandType.StoredProcedure
        ...
        Public Function CountEmployees(ByVal startRowIndex As Integer, ByVal maximumRows As Integer) As Integer
            Dim con As New SqlConnection(connectionString)
            Dim cmd As New SqlCommand("CountEmployees", con)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.Add(New SqlParameter("@startRowIndex", SqlDbType.Int))
            cmd.Parameters("@startRowIndex").Value = startRowIndex + 1
            cmd.Parameters.Add(New SqlParameter("@maximumRows", SqlDbType.Int))
        ...
        ' For paging 
        Public Function GetEmployees(ByVal startRowIndex As Integer, ByVal maximumRows As Integer) As List(Of EmployeeDetails)
            Dim con As New SqlConnection(connectionString)
